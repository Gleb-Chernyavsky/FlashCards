    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (scanner3.hasNext()) {
                ...
                s2 = scanner3.nextLine();
                s3 = scanner3.nextLine();
                cards.put(s1, s2);
                errors.put(s1, Integer.parseInt(s3));
                counter3++;
            }
            writingInfo((counter3) + " cards have been loaded.");
        ...
        String strOu = args[3];
        File filee = new File(strOu);
        FileWriter fileWriter2 = null;
        try {
            fileWriter2 = new FileWriter(filee);
            for (Map.Entry entry : cards.entrySet()) {
                fileWriter2.write(entry.getKey().toString());
                fileWriter2.write("\n");
                fileWriter2.write(entry.getValue().toString());
                fileWriter2.write("\n");
                fileWriter2.write(errors.get(entry.getKey()).toString());
                fileWriter2.write("\n");
            }
        } catch (Exception e) {
